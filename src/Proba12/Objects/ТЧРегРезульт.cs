...
namespace IIS.Proba12
{
    ...
    public class ТЧРегРезульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba12.ИтогСобес fИтогСобес;
        
        private int fОценкаКандид;
        
        private string fКрКомИлиОбсРеш;
        
        private IIS.Proba12.РегРезульт fРегРезульт;
        ...
        public virtual IIS.Proba12.ИтогСобес ИтогСобес
        {
            get
            {
                ...
                IIS.Proba12.ИтогСобес result = this.fИтогСобес;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Proba12.РегРезульт.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РегРезульт"})]
        public virtual IIS.Proba12.РегРезульт РегРезульт
        {
            get
            {
                ...
                IIS.Proba12.РегРезульт result = this.fРегРезульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧРегРезультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧРегРезультE", typeof(IIS.Proba12.ТЧРегРезульт));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧРегРезульт : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Proba12.DetailArrayOfТЧРегРезульт members)

        // *** End programmer edit section *** (IIS.Proba12.DetailArrayOfТЧРегРезульт members)
        ...
        /// </summary>
        public DetailArrayOfТЧРегРезульт(IIS.Proba12.РегРезульт fРегРезульт) : 
                base(typeof(ТЧРегРезульт), ((ICSSoft.STORMNET.DataObject)(fРегРезульт)))
        {
        }
        
        public IIS.Proba12.ТЧРегРезульт this[int index]
        {
            get
            {
                return ((IIS.Proba12.ТЧРегРезульт)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Proba12.ТЧРегРезульт dataobject)
        {
