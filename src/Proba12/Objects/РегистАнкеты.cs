...
namespace IIS.Proba12
{
    ...
    [MasterViewDefineAttribute("РегистАнкетыE", "Должности", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Должности")]
    ...
    public class РегистАнкеты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba12.Должности fДолжности;
        ...
        /// Регист анкеты.
        /// </summary>
        // *** Start programmer edit section *** (РегистАнкеты.Должности CustomAttributes)

        // *** End programmer edit section *** (РегистАнкеты.Должности CustomAttributes)
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Proba12.Должности Должности
        {
            get
            {
                // *** Start programmer edit section *** (РегистАнкеты.Должности Get start)

                // *** End programmer edit section *** (РегистАнкеты.Должности Get start)
                IIS.Proba12.Должности result = this.fДолжности;
                // *** Start programmer edit section *** (РегистАнкеты.Должности Get end)

                // *** End programmer edit section *** (РегистАнкеты.Должности Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (РегистАнкеты.Должности Set start)

                // *** End programmer edit section *** (РегистАнкеты.Должности Set start)
                this.fДолжности = value;
                // *** Start programmer edit section *** (РегистАнкеты.Должности Set end)

                // *** End programmer edit section *** (РегистАнкеты.Должности Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыE", typeof(IIS.Proba12.РегистАнкеты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РегистАнкетыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистАнкетыL", typeof(IIS.Proba12.РегистАнкеты));
                }
            }
        }
    }
