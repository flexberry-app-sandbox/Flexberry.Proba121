...
namespace IIS.Proba12
{
    ...
    [View("ПланирСобесE", new string[] {
            ...
            "РегистАнкеты.СерНомПаспорта",
            "РегистАнкеты.НомерТелефона",
            "РегистАнкеты.Снилс",
            "РегистАнкеты.ЭлПочта",
            "РегистАнкеты.Должности.Должности",
            "РегистАнкеты.Организация.Наименование",
            "РегистАнкеты.Организация.Адрес",
            "РегистАнкеты.Организация.ТелОрганиз"}, Hidden=new string[] {
    ...
    [View("ПланирСобесL", new string[] {
            ...
            "РегистАнкеты.Организация.Наименование",
            "РегистАнкеты.Организация.Адрес",
            "РегистАнкеты.Организация.ТелОрганиз"})]
    public class ПланирСобес : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba12.РегистАнкеты fРегистАнкеты;
        ...
        [PropertyStorage(new string[] {
                "РегистАнкеты"})]
        [NotNull()]
        public virtual IIS.Proba12.РегистАнкеты РегистАнкеты
        {
            get
            {
                ...
                IIS.Proba12.РегистАнкеты result = this.fРегистАнкеты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланирСобесE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесE", typeof(IIS.Proba12.ПланирСобес));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланирСобесL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесL", typeof(IIS.Proba12.ПланирСобес));
                }
            }
        }
    }
